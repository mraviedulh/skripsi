              ...
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p
                    ...
                    Saldo Total</p>
                  <h5 class="mb-2 font-bold">Rp. {{ number_format($totalSaldo, 0, ',', '.') }}</h5>
                </div>
              </div>
              ...
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p
                    class="mb-0 font-sans text-sm font-semibold leading-normal uppercase">
                    Jumlah Santri</p>
                  <h5 class="mb-2 font-bold">{{ $totalSantri }}</h5>
                </div>
              </div>
              <div class="px-3 text-right basis-1/3">
                <div
        ...
        <div
          ...
          <div class="flex-auto p-4 min-h-[180px]">
            <div class="flex flex-row -mx-3">
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase">Saldo Masuk</p>
                  <h5 class="mb-2 font-bold">{{ number_format($totalMasukHarian, 0, ',', '.') }}</h5>
                </div>
              </div>
              <div class="px-3 text-right basis-1/3">
                <div
              ...
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p
                    class="mb-0 font-sans text-sm font-semibold leading-normal uppercase">
                    Saldo Keluar</p>
                  <h5 class="mb-2 font-bold">{{ number_format($totalKeluarHarian, 0, ',', '.') }}</h5>
                </div>
              </div>
              <div class="px-3 text-right basis-1/3">
                <div
